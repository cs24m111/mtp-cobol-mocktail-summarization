...
using classic Reaching Definitions Analysis.
...
def save_dfg_to_json(cfg: CFGGraph, dfg_edges, path):
    """
...
def export_dfg_graph(cfg: CFGGraph, dfg_edges, out_prefix):
    """
    ...
    id_map = {}
    for idx, node_id in enumerate(cfg.nodes.keys()):
